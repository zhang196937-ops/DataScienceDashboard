"""
Django settings for datasci_dashboard project.
...
#SECRET_KEY = 'django-insecure-=f10l1hg8y*8z$^ao!adw$%r!@t0x+ts2+_qbke24(18nt28@('
...
ROOT_URLCONF = 'datasci_dashboard.urls'
...
WSGI_APPLICATION = 'datasci_dashboard.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS':{
           'connect_timeout': 60,  # Fail fast if connection issues
        }
    }
}
